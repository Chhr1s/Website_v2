...
Looks like the linear `{y}` is inadequate acrross all measures. \n
...
With this call, I can stack the actual and predicted trajectory graphs:
...
Again, let's stack the actual and predicted trajectory graphs:
